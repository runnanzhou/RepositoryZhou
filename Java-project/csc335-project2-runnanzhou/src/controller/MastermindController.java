 ...
 * important role in it. The design is to gather every judge issue in this 
 * class. The implementation is based on the MCV idea.
 */
public class MastermindController {
    ...
    public boolean isCorrect(String guess) {
    	//This class is to judge whether the input is correct, as a way to test.
    	//@param: String guess
    	//@return: boolean
    ...
    public int getRightColorRightPlace(String guess) {
    	//This class is to return the number of right color at right place.
    	//@param: String guess
    	//@return : int count;
    ...
    public int getRightColorWrongPlace(String guess) {
    	//This class is to return the number of right color at wrong place.
    	//@param: String guess
    	//@return : int count;
    	int count=0;
